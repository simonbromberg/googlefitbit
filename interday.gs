...
function getFitbitService() {
  ...
  return OAuth2.createService(SERVICE_IDENTIFIER)
      ...
      .setScope('activity profile settings')
...
function setup() {
    ...
    var listPanel = app.createGrid(7, 3);
    ...
    listPanel.setWidget(6, 0, app.createLabel("Data Elements to download:"));
    listPanel.setWidget(6, 1, loggables);
